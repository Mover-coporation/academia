...
class Class_mod extends CI_Model
{
	...
	#function to save a new class

	function add_class($classdetails)

	{

		$query = $this->Query_reader->get_query_by_code('add_class', $classdetails);
	...
	function update_class($classdetails)
