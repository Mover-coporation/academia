...
<title><?php echo SITE_TITLE." : School User Data";?></title>
    ...
    <td valign="top" style="padding:0"><div id='leftmenu' style="">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		  ...
		  <?php  
$this->load->view('incl/admin_leftmenu', array('mselected' => 'users' ));?>
           </td>
        </tr>
        </table>
<br />
        ...
        <table border="0" cellspacing="0" cellpadding="10" width="100%" id='contenttable'>
          <tr>
            <td colspan="2" style="padding-top:0px;" class="pageheader">
            	<table>
          		<tr>
            		<td valign="middle"><div class="page-title">Add User Details</div></td>
            		<td valign="middle">&nbsp;</td>
                    <td valign="middle">&nbsp;</td>
            	</tr>
          </table>
...
?>           
          ...
          <tr>
            <td valign="top">
            <form id="form1" name="form1" method="post" action="<?php echo base_url();?>admin/save_user<?php 
		if(!empty($i))
		{
			echo "/i/".$i;
		}
		?>" >
					 ...
					 if(!empty($isview))
			{
				echo "<span class='viewtext'>".$userdetails['address']."</span><input type='hidden' name='address' id='address' value='".$userdetails['address']."' />";
					 ...
					 echo get_required_field_wrap($requiredfields, 'emailaddress');?>
                      <input type="text" name="addressline1" id="addressline1" class="textfield" size="30" value="<?php 
				  if(!empty($userdetails['addressline1'])){
				 	 echo $userdetails['addressline1'];
				  }?>"/>
                      <?php  echo get_required_field_wrap($requiredfields, 'addressline1', 'end');
			}
				  ?>
                    </td>
                  </tr>
