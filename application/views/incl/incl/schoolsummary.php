      ...
      <div id="info" CLASS="long">
          ...
          <div id="info-small">
              <span id="figures" class="color-green">
                  <?php
                  $total_credits=  number_filter($total_credit['total']);
 ...
 <div  class="summarywrapper school_summary setup" id="" >
     ...
     <div id="info" class="long">
         ...
         <div id="info-small">
             <span id="figures" class="">
                 <?php
                 $classes= number_filter($classes['class_count']);
                 echo  $classes;  ?>
         ...
         <div id="info-small">
             ...
             <span id="figures" class="">  <?php
                 $terms= number_filter($terms['terms']);
                 echo  $terms;
                 ?>
         ...
         <div id="info-small">
             ...
             <span id="figures" class="">
                 <?php
                 $users= number_filter($users['schoolusers']);
                 echo  $users;
                ?>
...
<div  class="summarywrapper library_summary library"  >
    <div id="info" class="long">
        ...
        <div id="info-small">
            <span id="figures" class="color-red">
                  <?php
                  $defaulters= number_filter($defaulters['defaulters']);
                  echo  $defaulters;
                  ?>
        ...
        <div id="info-small">
            <span id="figures" class="">
                 <?php
                 $available= number_filter($available['books']);
                 echo  $available;
                 ?>
