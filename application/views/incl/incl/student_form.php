		...
		?>" >
			...
			if(!empty($isview))
			{
				echo "<span class='viewtext'>".$userdetails['firstname']."</span>";
				  ...
				  ?>
                    ...
                    <td rowspan="8" nowrap class="field" valign="top">
                    	<table>
                        <tr>
			...
			if(!empty($isview))
			{
				echo "<span class='viewtext'>".$studentdetails['studentno']."</span>";
				  ...
				  <tr>
                    <td>&nbsp;</td>
                    <td><input type="button" onclick="updateFieldLayer('<?php echo base_url().'students/save_student';?>','firstname<>lastname<>*dob<>*middlename<>gender<>admissionterm<>admissionclass<>*photo<>*studentno<>*guardianone<>*guardianonerelationship<>*guardianoneoccupation<>*guardianonetelephone<>*guardianoneaddress<>save','','results','Please enter the required fields.');uploadPhotoViaAjax();" name="save" id="save" value="Save" class="button"/></td>
                    <td>&nbsp;</td>
                  </tr>
                  <?php } ?>
                </table>
