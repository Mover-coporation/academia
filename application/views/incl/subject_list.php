<?php  
	...
	foreach($page_list AS $row)
	{
		...
		if(is_array($classids))
		{
		  ...
		  {
			  $class_str = get_class_title($this, $classids[0]);
		  }
		}
		else
		{
		...
		<td class='leftListCell rightListCell' valign='middle' nowrap>";
				...
				echo "<a href='javascript:void(0)' onclick=\"confirmDeleteEntity('".base_url()."curriculum/delete_subject/i/".encryptValue($row['id'])."', 'Are you sure you want to remove this subject? \\nThis operation can not be undone. \\nClick OK to confirm, \\nCancel to cancel this operation and stay on this page.');\" title=\"Click to remove ".$row['subject']." from the school curriculum.\"><img src='".base_url()."images/delete.png' border='0'/></a>";
			#}
	...
	pagination($this->session->userdata('search_total_results'), $rows_per_page, $current_list_page, base_url()."curriculum/manage_subjects/p/%d")
	."</td>
	</tr>
	</table>";	
			}
