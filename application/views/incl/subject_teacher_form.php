			...
			if(!empty($isview))
			{
				echo "<span class='viewtext'>".$formdata['papers']."</span>";
				  ...
				  <tr>
					...
					?></td>
                    <td><input type="button" onclick="updateFieldLayer('<?php echo base_url().'curriculum/assign_teacher'.((!empty($i))? '/i/'.$i : '');?>','subject<>teacher<>class<><?php if(count($papers)) echo 'paper<>'; ?>save','','assign-teacher-subject-results','Please enter the required fields.');" name="save" id="save" value="Save" class="button"/><input type="hidden" id="subject" name="subject" value="<?php echo $formdata['id']; ?>" /></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    </tr>
